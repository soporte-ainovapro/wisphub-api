"""
Tests now target WispHubTicketGateway directly (mocking HTTP calls)
...
from app.domain.models.tickets import TicketCreate
...
MOCK_WISPHUB_TICKETS_LIST = {
    "results": [
        {"id_ticket": 1, "asunto": "Test", "estado": "Abierto", "prioridad": "2",
         "fecha_estimada_inicio": "2026-02-26 10:00", "fecha_estimada_fin": "2026-02-28 10:00",
         "respuestas": None, "servicio": {"zona": {"id": 10}}},
        {"id_ticket": 2, "asunto": "Test", "estado": "Abierto", "prioridad": "2",
         "fecha_estimada_inicio": "2026-02-26 10:00", "fecha_estimada_fin": "2026-02-28 10:00",
         "respuestas": None, "servicio": {"zona": {"id": 10}}},
        {"id_ticket": 3, "asunto": "Test", "estado": "Abierto", "prioridad": "2",
         "fecha_estimada_inicio": "2026-02-26 10:00", "fecha_estimada_fin": "2026-02-28 10:00",
         "respuestas": None, "servicio": {"zona": {"id": 10}}},
    ]
}
