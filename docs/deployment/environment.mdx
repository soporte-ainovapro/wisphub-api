...
<Accordion title="JWT_SECRET_KEY">
**Type**: `str`

**Purpose**: Secret key used to sign and verify JWT tokens. Must be a cryptographically random string.
...
<Accordion title="JWT_ALGORITHM">
**Type**: `str`

**Purpose**: Algorithm used to sign JWT tokens.
...
<Accordion title="JWT_ACCESS_TOKEN_EXPIRE_MINUTES">
**Type**: `int`

**Purpose**: How long JWT tokens remain valid, in minutes.
...
<Accordion title="API_USERNAME">
**Type**: `str`

**Purpose**: Username for the single API user. Used in `POST /api/v1/auth/token`.
...
<Accordion title="API_PASSWORD_HASH">
**Type**: `str` (bcrypt hash)

**Purpose**: Bcrypt hash of the API user's password. The plain-text password is **never** stored.
