---
title: "Get Client by Service ID"
description: "Retrieve client information using their WispHub service ID"
---

## GET /api/v1/clients/by-service-id/{service_id}
...
service_id = "12345"
url = f"https://api.wisphub.example/api/v1/clients/by-service-id/{service_id}"
...
fetch(`https://api.wisphub.example/api/v1/clients/by-service-id/${serviceId}`, {
  method: 'GET',
  headers: {
    'Content-Type': 'application/json'
  }
