...
<ParamField body="subject" type="string" required>
  Brief summary of the ticket issue. **Must match exactly one of the valid subjects returned by [`GET /api/v1/tickets/subjects`](/api-reference/tickets/list-subjects).** WispHub uses this value to automatically assign the ticket's priority level.
</ParamField>
...
<ParamField body="technician_id" type="integer | null" required>
  ID of the assigned technician. Can be null if not yet assigned
</ParamField>
